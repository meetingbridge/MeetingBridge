...
public class PastMeetupFragment extends Fragment {
    ...
    public PastMeetupFragment() {
        // Required empty public constructor
    }

    public static PastMeetupFragment newInstance(String id) {
        PastMeetupFragment dis = new PastMeetupFragment();
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.fragment_pastmeetup, container, false);
